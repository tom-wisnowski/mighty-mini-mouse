...
public class NotificationAction : IAction
{
    ...
    public Task ExecuteAsync(CancellationToken ct = default)
    {
        try
        {
            ...
            {
                TrayNotificationBridge.TrayIcon.BalloonTipTitle = "BT Input Interceptor";
            ...
            else
            {
                ...
                MessageBox.Show(_message, "BT Input Interceptor", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
